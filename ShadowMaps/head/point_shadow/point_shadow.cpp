...
void PointShadow::initScene(GLFWwindow *window){
    ...
    Model marry(FileSystem::getPath("resources/model/marry/Marry.obj").c_str());
    Shader lightShader(this->LightShaderVs, this->LightShaderFs, this->LightShaderGeo.c_str());
    Shader cubeShader(this->CubeShaderVs, this->CubeShaderFs);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        this->renderCube(lightShader);
        glm::mat4 model = glm::mat4(1.0f);
        model = glm::scale(model, glm::vec3(0.5f));
        lightShader.setMat4("model", glm::translate(model, glm::vec3(0.0f, -2.0f, 0.0f)));
        marry.Draw(lightShader);
        glBindFramebuffer(GL_FRAMEBUFFER, 0);
        ...
        cubeShader.setMat4("view", viewer);
        ...
        glBindTexture(GL_TEXTURE_CUBE_MAP, this->CubeDepthTex);
        this->renderCube(cubeShader);
        
        cubeShader.setMat4("model", glm::translate(glm::scale(glm::mat4(1.0f), glm::vec3(0.5f)), glm::vec3(0.0f, -2.0f, 0.0f)));
...
void PointShadow::renderCube(Shader &shader){
    glm::mat4 model = glm::mat4(1.0f);
